...
//      panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Create Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 261, 230)));
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/signupimageicon.png"));
     ...
     public void actionPerformed(ActionEvent ae){
         ...
         if (ae.getSource()== create){
             ...
             try{
               ...
               JOptionPane.showMessageDialog(null, "Account Created Succ essfully");
               setVisible(false);
               new Login();
             }  
             catch (Exception e){
